//! The WHATWG HTML named character references (ADR-036 hidden-content hold).
//!
//! Generated from `https://html.spec.whatwg.org/entities.json` (last modified
//! 2025-11-12, fetched 2026-09-25): 2,231 names, 106 of them the legacy
//! names that are also valid without their `;`. Each entry is the name
//! without `&` (with its `;` where the table has one) and its code points,
//! sorted by name bytes for binary search. Do not edit by hand.
...
/// The longest entity name, in bytes.

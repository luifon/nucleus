...
This was not an edge case. In the week of 2026-07-14, 4 of 6 daily-report
...
The persistent profile existed for one reason: **logins** (a web app
...
- Auth expiry changes shape: instead of a lock error, an expired snapshot
  ...
  file surgery. The lock-recovery ladder in the triage skill is replaced
  accordingly.
...
- web-app workspace (the board behind reminder #19's failed

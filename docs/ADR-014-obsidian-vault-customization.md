...
`Luiz Workspace.md` static bio file from the Hermes era left over as
...
Replace the stale `Luiz Workspace.md` with a real dashboard:
...
- Old `Luiz Workspace.md` moves to `7-Archives/2026-05-23-luiz-workspace.md`
...
1. **Write `Home.md`** at vault root with Bases + Dataview queries
   inline; move existing `Luiz Workspace.md` → `7-Archives/`.

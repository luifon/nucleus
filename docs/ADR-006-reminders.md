...
- We lose the very specific guarantee "the end-of-day plist's schedule lives in launchd's calendar interval logic." Some operators might find that more familiar. Counter: that "familiar" path is what burned today.

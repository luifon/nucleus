...
PERSISTENT="dev.nucleus.discord dev.nucleus.whatsapp dev.nucleus.nucleus-dashboard dev.nucleus.bonsai com.example.cloudflared com.example.container-service"
